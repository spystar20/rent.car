...
import '/pattern.jpeg'
import img from '/play_store.png'
import img2 from '/app_store_.png'
const playstore = () => {
  return (
    
        <div className=' px-4 py-16 md:px-14 md:py-20 md:w-full lg:w-full lg:py-10 dark:bg-black'>
     <div  className='rounded-xl  text-center flex flex-col py-1 px-3 md:py-48 gap-8 md:justify-center md:items-center ' style={{backgroundImage:"url('/pattern.jpeg')" , backgroundPosition:"center",backgroundRepeat:"no-repeat",height:"39vh", width:'100%',backgroundSize:"cover"}} >
